...
const About = () => {
  return (
    <div className="flex flex-col-reverse justify-center items-center bg-cover bg-center pt-[5rem] p-8 pb-12 w-full lg:flex-row lg:min-h-[100vh] lg:px-28">
      ...
      <div className="flex flex-col items-center justify-center text-center pt-12 lg:pt-0 lg:pl-20 lg:w-6/12 lg:text-right lg:items-end lg:justify-center lg:h-[70vh]">
        <h1 className=" text-3xl font-bold lg:text-4xl xl:text-6xl text-black">
          Who we are!
        </h1>
        <p className=" text-lg my-8 font-serif opacity-95 text-black">
